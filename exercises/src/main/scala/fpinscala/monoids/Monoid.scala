...
object Monoid {
  ...
  {
    def op(a1: A=> A, a2: A => A) = a1 compose a2 //could be a2 compose a1 and it becomes a dual of this.
    val zero = (a:A) => a
  }
  ...
  def monoidLaws[A](m: Monoid[A], gen: Gen[A]): Prop =
    ...
    forAll(gen)(a => m.op(m.zero, a) == m.op(a, m.zero))
  ...
  def foldLeft[A, B](as: List[A])(z: B)(f: (B, A) => B): B =
    foldMap(as, Monoid.dual(endoMonoid[B]))(a => b => f(b, a))(z)
